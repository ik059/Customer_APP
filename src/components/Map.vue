<template>
  <div id="mapContainer3">
    ...
    <!-- <button style="background:transparent; border:none;"><img style="height: 30px;" src="https://i.ibb.co/Vvz91WD/Near-Me-2.png"/></button> -->
  </div>
  ...
  <div id="mapContainerTable"  style="">
  ...
  <div v-for="machine in sortedMarkers" :key="machine.id" class="machine-item">
    ...
    <button  class="btn btn-success" @click="value = machine.machineID" v-on:click="checkedasInterest(machine)" style="border: none; padding:2px !important; background-color: grey !important;" v-else> Interessiert</button>
  </div>
</div>
