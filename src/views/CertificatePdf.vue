    ...
    <div v-else>
      <div id="certificate" v-if="certificateDetails.certificateID">
        ...
        <div id="logoQr">
              <div>
                <qrcode-vue
                  :value="`https://${process.env.VUE_APP_HOST}/#/certificate/pdf/?certificate=${certificateID}`"
                  :size="size"
                  level="H"
                />
              </div>
        ...
        <div style="margin-top: 5px; margin-right: 18% !important">
          ...
          src="https://container-hygiene.de/webapps/customerapp/IMG_1718883816188.jpg"
        />
    ...
    exportToPDF(certificateDetails) {
      ...
      axios
        ...
        .then((response) => {
          ...
          a.href = url;
          a.download = `Reinigungsnachweis_${this.washType}_${certificateDetails.certificateID}.pdf`;
